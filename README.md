...
Zero-dependency static HTML (hub + `claude-skill-lint/`). `python3 scripts/check_site.py` gates every `*.html` page — structure, local assets, and link liveness — in CI. Offline unit tests live in `scripts/test_check_site.py`.
